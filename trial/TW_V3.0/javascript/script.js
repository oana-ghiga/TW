...
const endpoint = 'http://your-backend-url/mainPage.php'; // Replace with your actual backend URL
const images = [];
      ...
      images.forEach(image => {
        ...
        imageCard.addEventListener('click', () => {
          ...
          if (clickedIdx !== -1) {
            ...
            const url = `../html/spotlightPage.html?imageSrc=${encodeURIComponent(imageSrc)}`;
